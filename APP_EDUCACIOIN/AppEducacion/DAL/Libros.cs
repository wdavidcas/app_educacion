...
namespace DAL
{
    ...
    public class ModelLibros
    {
        ...
        /// <param name="codigo">codigo o isbn</param>
        /// <param name="paginas">paginas</param>
        /// <param name="cantidad">cantidad de libros</param>
        /// <param name="cantidadDisponible">cantidad de libros disponibles</param>
        /// <param name="descripcion">descripcion</param>
        /// <param name="estado">estado</param>
        public ModelLibros(int pk, string nombre, string autor,string editorial,string codigo,int paginas,int cantidad,int cantidadDisponible, string descripcion, int estado,int tipolibro)
        {
            this.PK = pk;
            this.Nombre = nombre;
            this.Autor = autor;
        ...
        public ModelLibros(int pk, string error)
        {
            this.PK = pk;
            this.Error = error;
        }
