<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modulo.aspx.cs" Inherits="AppEducacion.Modulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="width:90%">
        <!--titulo de la pagina-->
        <h4 style="text-align:center;color:#08088A" class="container">ADMINISTRACIÓN DE MODULOS</h4>
        <br />
        ...
        <div id="formulario" title="Informaci&oacute;n del Módulo" class="modal">            
            <div class="row">
                ...
                <div class="col-md-4">
                    <input id="txtNombre" title="Nombre del módulo" type="text" placeholder="Ingrese nombre" maxlength="25" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this); revisarObligatorio(this); revisarLongitud(this,25)" onkeypress="convertir(this,'may')"/>
                </div>
            </div>
            <br />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <textarea id="txtDescripcion" title="Descripción del módulo" rows="4" placeholder="Ingrese descripci&oacute;n" maxlength="50" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this);revisarLongitud(this,50)" onkeypress="convertir(this,'may')"></textarea>
                </div>
            </div>
            <br />
            <div class="row">
                ...
                <div class="col-md-4">
                    <select id="ddlEdificios" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this)" title="Edificio donde esta el módulo">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <select id="ddlEstado" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this)" title="Estado del módulo">
