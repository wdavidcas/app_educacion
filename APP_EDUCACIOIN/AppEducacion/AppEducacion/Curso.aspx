    ...
    <div class="container" style="width:90%">
        ...
        <div id="formulario" title="Informaci&oacute;n" class="modal">   
            ...
            <div class="row">  
                ...
                <div class="col-md-4">
                    <label>Cód. Mineduc</label>
                </div>
                <div class="col-md-4">
                    <input id="txtCodigoMineduc" type="text" placeholder="Ingrese código" maxlength="20" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this); revisarObligatorio(this); revisarLongitud(this,20)" />
                </div>
            </div>
            <br />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <input id="txtCreditos" type="text" placeholder="Ingrese código" maxlength="20" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this); revisarObligatorio(this); revisarLongitud(this,20)" />
                </div>
            </div>
            <br />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <select id="ddlNivels" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this)">
