...
$(window).load(function () {
    ...
    headColumnas.push(["NOMBRE", "APELLIDO","CARNET","DPI","DIRECCION", "EDITAR", "VER", "BORRAR"]);
    //array para el ancho de las columnas
    var widthColumnas = new Array();
    widthColumnas.push([17, 17,11,11,25, 8, 8, 8]);
    ...
    function getData(filaInicial, cantidad) {
        ...
        $.ajax({
            type: "POST",
            url: "Alumno.aspx/ObtenerListado",
    ...
    function crearTabla(response) {
        ...
        if (listado.length > 0) {
            ...
            for (var i = 0; i < listado.length; i++) {
                ...
                for (var j = 0; j < columnCount; j++) {
                    ...
                    if (j == 5) {
                        ...
                        cell.appendChild(crearEnlace(listado[i].PK, "Seleccionar"));
                    }
                    else if (j == 7) {
                        ...
                        cell.innerHTML = listado[i].Apellido;
                    }
                    else if (j == 2) {
                        cell.innerHTML = listado[i].Carnet;
                    }
                    else if (j == 3)
                    {
                        cell.innerHTML = listado[i].Cui;
                    }
                    else if (j == 4) {
                        cell.innerHTML = listado[i].Direccion;
                    }
                }
            }
            ...
            dvTable.className = "errorCategoriaNivel";
