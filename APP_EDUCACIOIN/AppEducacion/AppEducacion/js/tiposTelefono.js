...
$(window).load(function () {
    ...
    function getData(filaInicial, cantidad) {
        ...
        $.ajax({
            type: "POST",
            url: "TiposTelefono.aspx/ObtenerListado",
    ...
    function getCount() {
        ...
        $.ajax({
            type: "POST",
            url: "TiposTelefono.aspx/ObtenerCount",
            data: JSON.stringify(param),
            contentType: "application/json;charset=utf-8",
            dataType: "json",
            async: false,
    ...
    $("#txtBusqueda").autocomplete({
        source: function (request, response) {
            ...
            $.ajax({
                type: "POST",
                url: "TiposTelefono.aspx/GetBusqueda",
    ...
    function Guardar(nombre, descripcion, estado) {
        if (validarIngreso(nombre, descripcion, estado)) {
            ...
            $.ajax({
                type: "POST",
                url: "TiposTelefono.aspx/Guardar",
                data: JSON.stringify(parametros),
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                async: true,
