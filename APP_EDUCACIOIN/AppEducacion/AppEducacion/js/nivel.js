    ...
    function getCategoriasNivel() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var combo = document.getElementById("ddlCategorias");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (listado.length > 0) {
                    ...
                    $("#ddlCategorias").val(categoriaNivel);
                    $("#pk").val(id);
                    ...
                    if (esGuardar == null) {
                        ...
                        $("#ddlCategorias").removeAttr("disabled");
                    }
                }
                else {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (listado.length > 0) {
                    ...
                    var descripcion = listado[0].Descripcion;
                    var estado = listado[0].Estado;
                    var categoria = listado[0].CategoriaNivel_Id;
