...
$(window).load(function () {
    ...
    headColumnas.push(["NOMBRE", "DESCRIPCION", "MODULO", "EDITAR", "VER", "BORRAR"]);
    ...
    function getModulos(edificioId) {
        var parametros = { "EdificioId": edificioId, "Estado": 1, "Orden": "ASC", "CampoOrden": "Nombre" };
        $.ajax({
            type: "POST",
            url: "Aula.aspx/ObtenerModulos",
    ...
    function getEdificios() {
        ...
        $.ajax({
            type: "POST",
            url: "Aula.aspx/ObtenerEdificios",
            data: JSON.stringify(parametros),
            async: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            ...
            success: function (response) {
                ...
                if (listado.length > 0) {
                    ...
                    if (esGuardar == null) {
                        ...
                        $("#ddlModulos").removeAttr("disabled");
                    }
                }
                else {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (listado.length > 0) {
                    ...
                    llave = id;
                    estado = 3;
                    Guardar(nombre, descripcion, estado, modulo);
            ...
            for (var i = 0; i < listado.length; i++) {
                ...
                for (var j = 0; j < columnCount; j++) {
                    ...
                    if (j == 3) {
                        ...
                        cell.innerHTML = listado[i].ModuloNombre;
                    }
                }
            }
    ...
    $('#formulario').dialog({
        ...
        buttons: {
            ...
            "Aceptar": function () {
                ...
                var modulo = $("select[id=ddlModulos]").val();
                llave = $("#pk").val();
                //guardar
                if (esGuardar == true) {
                    Guardar(nombre, descripcion, estado, modulo);
