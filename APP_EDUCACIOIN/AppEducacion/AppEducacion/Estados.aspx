<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Estados.aspx.cs" Inherits="AppEducacion.Estados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="width:90%">
        <!--titulo de la pagina-->
        <h4 style="text-align:center;color:#08088A" class="container">ADMINISTRACIÓN DE NIVELES</h4>
        <br />
        ...
        <div id="formulario" title="Informaci&oacute;n" class="modal">            
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <select id="ddlTiposEstado" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this)">
