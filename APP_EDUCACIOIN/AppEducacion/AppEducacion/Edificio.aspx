<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edificio.aspx.cs" Inherits="AppEducacion.Edificio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/edificio.css" rel="stylesheet" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="width:90%">
        <!--titulo de la pagina-->
        <h4 style="text-align:center;color:#08088A" class="container">ADMINISTRACIÓN DE EDIFICIOS</h4>
        <br />
        ...
        <div id="formulario" title="Informaci&oacute;n del Edificio" class="modal">            
            <div class="row">
                ...
                <div class="col-md-4">
                    <input id="txtNombre" title="Nombre del edificio" type="text" placeholder="Ingrese nombre" maxlength="25" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this); revisarObligatorio(this); revisarLongitud(this,25)" onkeypress="convertir(this,'may')" />
                </div>
            </div>
            <br />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <textarea id="txtDescripcion" title="Descripción del edificio" rows="4" placeholder="Ingrese descripci&oacute;n" maxlength="50" onfocus="entroEnFoco(this)" onblur="salioDeFoco(this);revisarLongitud(this,50)" onkeypress="convertir(this,'may')"></textarea>
                </div>
            </div>
            <br />
