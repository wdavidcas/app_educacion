...
INSERT INTO `bdcolegio`.`TIPO_ACTIVIDAD` (`id`, `nombre`, `descripcion`, `estado`, `user`) VALUES (DEFAULT, 'EXAMEN CORTO', 'EXAMEN CORTO', 1, 'ADMIN');
INSERT INTO `bdcolegio`.`TIPO_ACTIVIDAD` (`id`, `nombre`, `descripcion`, `estado`, `user`) VALUES (DEFAULT, 'QUIZ', 'QUIZ', 1, 'ADMIN');
